...
<main id="contenido">
  <section class="tight">
    <div class="wrap wrap-narrow">
      ...
      ${activo
        ? `<p class="cambiar">¿Quieres cambiar tu aportación? Escríbenos a <a href="mailto:info@justiciapoetica.org">info@justiciapoetica.org</a> diciéndonos el importe nuevo y lo cambiamos en el momento.</p>`
        : ''}
    </div>
  </section>
</main>
