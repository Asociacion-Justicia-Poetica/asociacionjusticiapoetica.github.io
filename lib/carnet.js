...
export function paginaCarnet({ nombre, nivel, numero, qr, activo, hasta, motivo, manifiesto }) {
  const estado = activo
...
${manifiesto ? `<link rel="manifest" href="${escapar(manifiesto)}">` : ''}
<meta name="theme-color" content="#124a48">
<!-- iOS no lee el manifiesto para esto: necesita sus propias etiquetas. -->
<meta name="mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-capable" content="yes">
<!-- "default" deja la barra de estado opaca y el contenido debajo. Con
     "black-translucent" el carnet se metería bajo el reloj. -->
...
<style>
  ...
  .guardar { margin-top: 1.5rem; border-top: 1px solid var(--line); padding-top: 1rem; }
  .guardar summary { cursor: pointer; font-weight: 600; font-size: .95rem; }
  .guardar p { font-size: .93rem; color: var(--ink-soft); margin: .8rem 0 0; }
  .cambiar { font-size: .93rem; color: var(--ink-soft); margin: 1.1rem 0 0; }
</style>
</head>
<body>
<main id="contenido">
  <section class="tight">
    <div class="wrap wrap-narrow">
      ...
      ${estado}
      <details class="guardar">
        <summary>Llévalo en el móvil</summary>
        <p><strong>iPhone.</strong> Con esta página abierta, toca el botón de compartir —el cuadrado con la flecha hacia arriba—, baja por la lista y elige <em>Añadir a pantalla de inicio</em>. Si no aparece esa opción, abre esta misma página en Safari y vuelve a intentarlo.</p>
        <p><strong>Android.</strong> Con esta página abierta, abre el menú del navegador —los tres puntos— y elige <em>Instalar aplicación</em> o <em>Añadir a pantalla de inicio</em>, según cómo lo llame el tuyo.</p>
        <p style="margin-bottom:0">Te quedará un icono propio y se abrirá a pantalla completa, sin barra de navegador. Necesita conexión, porque comprueba tu aportación cada vez que se abre: por eso siempre dice la verdad.</p>
      </details>
      ...
      ${activo
        ? `<p class="cambiar">¿Quieres cambiar tu aportación? Escríbenos a <a href="mailto:asociacionjusticiapoetica@gmail.com">asociacionjusticiapoetica@gmail.com</a> diciéndonos el importe nuevo y lo cambiamos en el momento.</p>`
        : ''}
    </div>
  </section>
</main>
