  ...
  <section class="tight">
    <div class="wrap wrap-narrow">
      ...
      <details class="guardar">
        ...
        <p><strong>iPhone.</strong> Con esta página abierta en Safari, toca el botón de compartir, baja y elige <em>Añadir a pantalla de inicio</em>.</p>
        <p><strong>Android.</strong> Con esta página abierta en Chrome, abre el menú de los tres puntos y elige <em>Añadir a pantalla de inicio</em> o <em>Instalar aplicación</em>.</p>
